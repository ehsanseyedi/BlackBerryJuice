...
public class MaterialDialog2 {
    ...
    private MaterialDialog2.Builder mBuilder;
    private View mView;
    private int mTitleResId;
    private CharSequence mTitle;
    private int mMessageResId;
    private CharSequence mMessage;
    private TextViewPlus mPositiveButton;
    private LinearLayout.LayoutParams mLayoutParams;
    private TextViewPlus mNegativeButton;
    ...
    public MaterialDialog2 setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public MaterialDialog2 setContentView(View view) {
     ...
     */
    public MaterialDialog2 setContentView(int layoutResId) {
    ...
    public MaterialDialog2 setBackground(Drawable drawable) {
    ...
    public MaterialDialog2 setBackgroundResource(int resId) {
    ...
    public MaterialDialog2 setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public MaterialDialog2 setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public MaterialDialog2 setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public MaterialDialog2 setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public MaterialDialog2 setPositiveButton(int resId, final View.OnClickListener listener) {
        this.pId = resId;
    ...
    public TextViewPlus getPositiveButton() {
        return mPositiveButton;
    }


    public TextViewPlus getNegativeButton() {
        return mNegativeButton;
    }


    public MaterialDialog2 setPositiveButton(String text, final View.OnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }
    ...
    public MaterialDialog2 setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
    ...
    public MaterialDialog2 setNegativeButton(String text, final View.OnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }
    ...
    public MaterialDialog2 setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public MaterialDialog2 setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    ...
    private class Builder {
        ...
        private TextViewPlus mMessageView;
        ...
        private Builder() {
            ...
            View contentView = LayoutInflater.from(mContext)
                                             .inflate(
                                                     R.layout.layout_materialdialog2,
                                                     null);
            ...
            mTitleView = (TextViewPlus) mAlertDialogWindow.findViewById(R.id.title);

                    mMessageView = (TextViewPlus) mAlertDialogWindow.findViewById(
                    R.id.message);
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(
                    R.id.buttonLayout);
            mPositiveButton = (TextViewPlus) mButtonLayout.findViewById(R.id.btn_p);
            mNegativeButton = (TextViewPlus) mButtonLayout.findViewById(R.id.btn_n);
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            TextViewPlus button = new TextViewPlus(mContext);
